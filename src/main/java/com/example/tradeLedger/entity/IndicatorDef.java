...
/**
 * Table {@code indicator_defs}: a compute primitive (EMA, RSI, ...).
 *
 ...
 * <ul>
 *   <li>{@link StrategyParamDef} - the strategy-level knob a user actually sets
 *       ({@code fast}, {@code slow}), with its own validation rules</li>
 *   <li>the {@code $key} bindings inside {@link Strategy#getRuleTree()}, which map
