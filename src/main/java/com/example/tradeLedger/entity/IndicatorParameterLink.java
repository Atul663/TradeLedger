...
/**
 * Table {@code indicator_parameter_links}: which parameters an indicator computes
 * with, by id.
 *
 * <pre>
 *   EMA CROSSOVER ──┬── K
 ...
 */
@Entity
@Table(name = "indicator_parameter_links",
        uniqueConstraints = @UniqueConstraint(name = "uq_indicator_parameter_links",
                columnNames = {"indicator_id", "parameter_id"}))
public class IndicatorParameterLink {
