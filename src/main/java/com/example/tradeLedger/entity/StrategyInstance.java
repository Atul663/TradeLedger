...
/**
 * Table {@code strategy_instances}: immutable, content-addressed configuration -
 * the dedup unit.
 *
...
@Table(name = "strategy_instances",
        uniqueConstraints = @UniqueConstraint(name = "uq_instances_dedup",
...
public class StrategyInstance {
    ...
    private StrategyInstance supersedes;
    ...
    public StrategyInstance getSupersedes() { return supersedes; }
    public void setSupersedes(StrategyInstance supersedes) { this.supersedes = supersedes; }
