...
/**
 * Strategy management over the {@code strategies} table.
 *
 * Distinct from the pre-existing {@code /api/v1/strategy} endpoints, which
 * manage the platform-wide on/off switches in {@code strategy_config} and are
 * left exactly as they were.
 */
@RestController
@RequestMapping("/api/v1/strategies")
@Tag(name = "Strategies", description = "Strategy templates, their rule trees and their tunable parameters")
public class StrategyDefinitionController extends SecuredController {
    ...
    public List<StrategyDetailResponse> list(@RequestParam(required = false) Boolean active,
    ...
    public StrategyDetailResponse get(@PathVariable UUID id) {
    ...
    public StrategyDetailResponse getByName(@PathVariable String name) {
    ...
    public StrategyDetailResponse create(@RequestBody StrategyRequest request) {
    ...
    public StrategyDetailResponse update(@PathVariable UUID id, @RequestBody StrategyRequest request) {
    ...
    public List<StrategyParamDefResponse> listParams(@PathVariable UUID id) {
    ...
    public StrategyParamDefResponse addParam(@PathVariable UUID id,
                                             @RequestBody StrategyParamDefRequest request) {
    ...
    public StrategyParamDefResponse updateParam(@PathVariable UUID id,
