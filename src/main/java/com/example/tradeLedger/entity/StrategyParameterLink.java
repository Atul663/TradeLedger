...
/**
 * Table {@code strategy_parameter_links}: the parameters that belong to a strategy
 ...
 * indicator parameter feeds a computation ({@link IndicatorParameterLink}), a
 ...
 */
@Entity
@Table(name = "strategy_parameter_links",
        uniqueConstraints = @UniqueConstraint(name = "uq_strategy_parameter_links",
                columnNames = {"strategy_id", "parameter_id"}))
public class StrategyParameterLink {
