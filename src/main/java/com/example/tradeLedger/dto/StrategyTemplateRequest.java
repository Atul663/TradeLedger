...
public class StrategyTemplateRequest {
    ...
    private List<StrategyParamDefinitionRequest> params;
    ...
    public List<StrategyParamDefinitionRequest> getParams() { return params; }
    public void setParams(List<StrategyParamDefinitionRequest> params) { this.params = params; }
}
