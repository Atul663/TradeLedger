...
/**
 * Table {@code strategy_param_defs}: ONE ROW PER KNOB.
 *
 ...
 * <ul>
 *   <li><b>signal</b>    &rarr; goes on {@link StrategyInstance}, inside the config hash</li>
 *   <li><b>execution</b> &rarr; goes on {@link Subscription}, personal, never hashed</li>
 * </ul>
 *
 ...
 */
@Entity
@Table(name = "strategy_param_defs",
        uniqueConstraints = @UniqueConstraint(name = "uq_param_defs_strategy_key",
                columnNames = {"strategy_id", "parameter_key"}))
public class StrategyParamDef {
    ...
    /** Strategy-local: "fast" in two strategies does not collide. */
